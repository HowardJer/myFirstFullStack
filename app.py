        ...
        try:
            ...
            if(rowcount == 1):
                ...
                return Response(json.dumps(blog, default=str),
                                mimetype="application/json",status=200)  #201
            else: 
                return Response("Failed", mimetype="html/text", status=200)   #400            
    if request.method == "DELETE":
        ...
        try:
            ...
            if(rowcount == 1): 
                ...
                return Response("Success",mimetype="html/text",status=200)  #201
            else: 
                return Response("Failed", mimetype="html/text", status=200)  #400                         
